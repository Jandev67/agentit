...
STRATEGIA_PROMPT_FILE = "strategia_prompt.txt"
PROMPT_TIEDOSTO = AGENTIT_KANSIO / STRATEGIA_PROMPT_FILE
...
def tervetuloa():
    print("\n" + "═" * 65)
    print("  Strategia-agentti")
    print("═" * 65)
    print("\nStrategia-agentti käynnissä. Olen verkoston strateginen selkäranka. Kysy yrittäjyyspolusta, konsulttibisneksestä, kokonaiskuvasta tai strategisesta viitekehyksestä.")
    print("\nLadataan kontekstit...")
...
def main():
    ...
    while True:
        ...
        try:
            print("\nStrategia-agentti: ", end="", flush=True)
